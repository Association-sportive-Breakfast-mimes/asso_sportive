    ...
    return (
        <div className = "table">
            <table className = "table-responsive">
                <thead>
                    <tr>
                        <th colSpan = "10"><h1>Cours Enfants</h1></th>
                    </tr>
                    <tr>
                        <th></th>
                        <th>10h-11h</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label = "12h - 13h" className = "cours">12h - 13h</td>
                    ...
                    <tr>
                        <td>Mercredi</td>
                        <td data-label = "10h - 11h"></td>
                        <td data-label = "11h - 12h">11h - 12h</td>
                        <td data-label = "12h - 13h" className = "cours">12h - 13h</td>
                        <td data-label = "15h - 16h"></td>
                        <td data-label = "16h - 17h" className = "cours">16h - 17h</td>
                        <td data-label = "17h - 18h" className = "cours">17h - 18h</td>
                    ...
                    <tr>
                        ...
                        <td data-label = "10h - 11h"></td>
                        <td data-label = "11h - 12h" className = "cours">11h - 12h</td>
                        <td data-label = "12h - 13h" className = "cours">13h - 14h</td>
                        <td data-label = "15h - 16h"></td>
                        <td data-label = "16h - 17h" className = "cours">16h - 17h</td>
                        <td data-label = "17h - 18h" className = "cours">17h - 18h</td>
                        <td data-label = "18h - 19h"></td>
